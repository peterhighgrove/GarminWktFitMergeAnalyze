...
public class RecordMesg extends Mesg   {
    ...
    static {int field_index = 0;
        ...
        System.out.println("-- START RecordMesg. STATIC block " + timeStamp);
        ...
        System.out.println("-- END STATIC block RecordMesg. " + timeStamp);
    }

    public RecordMesg() {
        // TAKES TIME when MesgBroadcaster broadcaster = new MesgBroadcaster(decode);
        super(Factory.createMesg(MesgNum.RECORD));
        //timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
        //System.out.println("-- END Constr1 RecordMesg. " + timeStamp);
}
